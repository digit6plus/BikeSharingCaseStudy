...
knit: (function(input_file, encoding) {
    ...
    rmarkdown::render(input_file,
      encoding=encoding,
      output_file=file.path(dirname(input_file), out_dir, 'Bike Sharing Case Study.html'))})
...
### 1. Collect Data The project officially begins with importing all the needed data. \#### Import datasets of 2022 data
